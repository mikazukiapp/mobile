/// Extended from original ExpansionTile from Flutter Team
...
class MikazukiExpansionTile extends StatefulWidget {
  /// Creates a single-line [ListTile] with a trailing button that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const MikazukiExpansionTile({
    Key key,
    this.leading,
    @required this.title,
    this.subtitle,
  ...
  @override
  _MikazukiExpansionTileState createState() => _MikazukiExpansionTileState();
}

class _MikazukiExpansionTileState extends State<MikazukiExpansionTile>
